/*
   ...
   Your task is to create a function that returns whatever number c isn't, out of a and b. So, if c is equal to a, return b, and if c is equal to b, return a.
...
void swap_the_numbers(int a, int b, int c)
{
    if (a == b)
    {
        printf("a should never be equal to b \n");
    }
    else if (a != b && c == b)
    {
        printf("a: %d \n", a);
    ...
    {
        printf("c should be equal to either a or b");
    }
}
